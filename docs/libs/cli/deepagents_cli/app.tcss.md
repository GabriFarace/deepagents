# `libs/cli/deepagents_cli/app.tcss`

> Textual stylesheet for the CLI application.

## Position in the system

`app.py` loads this stylesheet to style screens and widgets. The class names used by the widget docs under `widgets/` are only half of the contract; selectors here are the other half.
...
Selector renames can break UI presentation without changing Python imports. Keep stylesheet changes coordinated with widget class names and screen IDs.
