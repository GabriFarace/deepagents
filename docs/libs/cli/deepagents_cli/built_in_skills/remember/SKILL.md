...
This file ships as part of the built-in skill catalog. The CLI lists it with lower precedence than user and project skills, so users can override the behavior by defining a skill with the same name in a higher-precedence directory.
